...
const items: Column[] = [
  {
    id: 1,
    elements: [
      { id: 1, height: 300, img: "/assets/images/anh1.jpg" },
      { id: 2, height: 250, img: "/assets/images/anh2.jpg" },
    ],
  },
  {
    id: 2,
    elements: [
      { id: 3, height: 180, img: "/assets/images/anh3.jpg" },
      { id: 4, height: 180, img: "/assets/images/se-uit.jpg" },
      { id: 5, height: 180, img: "/assets/images/anh5.jpg" },
    ],
  },
  {
    id: 3,
    elements: [
      { id: 6, height: 300, img: "/assets/images/anh6.jpg" },
      { id: 7, height: 250, img: "/assets/images/anh4.png" },
    ],
  },
];
...
const One: React.FC = () => {
  ...
  return (
    <div className="flex-center w-full center relative h-full overflow-hidden">
      <motion.div
        layout
