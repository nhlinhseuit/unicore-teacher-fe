...
type ReportInfoProps = {
  ...
  setIsSubmitting: Dispatch<SetStateAction<boolean>>; // Hàm setter cho isSubmitting
  selectedFiles: File[]; // Mảng các file đã chọn
  setSelectedFiles: Dispatch<SetStateAction<File[]>>; // Hàm setter cho selectedFiles
  selectedGradeColumn: number; // Giá trị cho grade column
  setSelectedGradeColumn: Dispatch<SetStateAction<number>>; // Hàm setter cho selectedGradeColumn
  selectedCourses: string[]; // Mảng các khoá học đã chọn
  setSelectedCourses: Dispatch<SetStateAction<string[]>>; // Hàm setter cho selectedCourses
};
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-col w-full gap-2">
                          ...
                          <FormDescription className="body-regular mt-2.5 text-light-500">
                            File đính kèm có thể ở các định dạng: docx, pdf,
                            pptx, xlsx, txt... Tối đa {MAX_FILE_VALUE}MB.
                          </FormDescription>
                          <FormMessage className="text-red-500" />
                        </FormItem>
                      )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex w-full flex-col">
                              ...
                              <FormDescription className="body-regular mt-2.5 text-light-500">
                                Nếu không chọn thời gian nộp bài thì sinh viên
                                sẽ được nộp bài ngay lập tức và không giới hạn
                                thời gian.
                              </FormDescription>
                              <FormMessage className="text-red-500" />
                            </FormItem>
                          ...
                          render={({ field }) => (
                            <FormItem className="flex w-full flex-col">
                              ...
                              <FormDescription className="body-regular mt-2.5 text-light-500">
                                ...
                                bài nhưng sẽ bị đánh dấu là nộp bài trễ. Sinh
                                viên sẽ không thể nộp bài tập khi quá ngày đóng
                                bài nộp.
                              </FormDescription>
                              <FormMessage className="text-red-500" />
                            </FormItem>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex w-full flex-col">
                              ...
                              <FormDescription className="body-regular mt-2.5 text-light-500">
                                Hệ thống sẽ gửi thông báo để nhắc bạn chấm bài
                                vào thời gian được chọn.
                              </FormDescription>
                              <FormMessage className="text-red-500" />
                            </FormItem>
                          )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex w-full flex-col">
                        ...
                        <FormDescription className="body-regular mt-2.5 text-light-500">
                          Thông báo này sẽ được đăng trong các lớp bạn chọn
                          ngoài lớp hiện tại.
                        </FormDescription>
                        <FormMessage className="text-red-500" />
                      </FormItem>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem className="flex w-full flex-col">
                                ...
                                <FormDescription className="body-regular mt-2.5 text-light-500">
                                  Thông báo sẽ được lên lịch để đăng vào ngày
                                  này mà bạn chọn.
                                </FormDescription>
                                <FormMessage className="text-red-500" />
                              </FormItem>
